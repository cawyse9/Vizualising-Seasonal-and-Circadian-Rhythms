# Vizualising Seasonal and Circadian Rhythms in Action
...
This image shows a slice through the hypothalamus of the brain.  The suprachiasmatic nuclei are two pear-shaped regions (stained in yellow) that contain the the master clock of the brain, timing physiology and behaviour to ensure that we are hungry, sleepy and alert at the right times of day.
...
## Immune Clocks
Macrophages are the soldiers, sentinels and messengers of the immune system. Microglia (bottom image) are a specialised type of macrophage in the brain. Our studies show that these cells have their own molecular clock that allows them to synchronise these protective roles to the times of day that we need them most.
